...
public abstract class XC_MethodReplacement extends XC_MethodHook {
    ...
    @Override
    public final void beforeHookedMethod(final MethodHookParam param) throws Throwable {
        try {
    ...
    public final void afterHookedMethod(final MethodHookParam param) throws Throwable {
    }
