...
#ifndef AGGREGATE_SIZE_UTIL_H
#define AGGREGATE_SIZE_UTIL_H
...
namespace kk {
    ...
    static void ResetSizeInfo(SizeInfo *info) {
        //视频原始尺寸
        info->src_width = 0;
        info->src_height = 0;
    ...
    initSizeInfo(SizeInfo *size, int dst_width, int dst_height, int dst_rotation, bool stretch) {
        ...
        ALOGD("video:rotation=%d, src=%dx%d, dst=%dx%d@%d ", size->src_rotation, size->src_width,
